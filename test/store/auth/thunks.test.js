...
import { clearNotesLogout } from '../../../src/store/journal/journalSlices';
...
describe('Pruebas en AuthThunks', () => { 
    ...
    test('debe de invocar el ckeckingCredentials', async() => { 
     ...
     test('startGoogleSignIn debe de llamar el checkingCredentials y logut - Error', async() => { 
